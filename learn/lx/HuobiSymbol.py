...
class dbo:
    ...
    def huobi(self, url, exchangePair):
        headers = {
            ...
            if respone.text.__len__() > 1:
                ...
                for i in range(0, len(d)):
                    ...
                    for j in range(0, len(exchangePair)):
                        ...
                        if (exchangePair[j][5] == symbol and exchangePair[j][4] == 4):
                            flag = 0
                    if (flag == 1):
                        ...
                        if (data.__len__() == 0):
                            db.insertExchangePair(nowDate, nowDate, 1, 4, symbol, baseCurrency,
                                                  quoteCurrency, -1, "Huobi.pro", "https://www.huobi.pro")
                        else:
                            baseCurrencyId = data[0][0]

                            db.insertExchangePair(nowDate, nowDate, 1, 4, symbol, baseCurrency,
                                                  quoteCurrency, baseCurrencyId, "Huobi.pro", "https://www.huobi.pro")
...
if __name__ == "__main__":
    ...
    db.huobi("https://api.huobipro.com/v1/common/symbols", exchangePair)
    print("火币交易对同步完毕")

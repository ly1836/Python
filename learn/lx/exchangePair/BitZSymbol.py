...
class dbo:
    ...
    def BitZ(self, url, exchangePair, exchangeName, exchangeId, exchangeUrl):
        counts = 0
        headers = {
    ...
    #读取json文件
    def readJsonFile(self,filePath,exchangePair, exchangeName, exchangeId, exchangeUrl):
        counts = 0
...
if __name__ == "__main__":
    ...
    #db.BitZ("https://apiv2.bitz.com/Market/symbolList", exchangePair,"Bit-Z",16,"https://www.bit-z.com")
    db.readJsonFile("c:\\exchangePair.json",exchangePair,"Bit-Z",16,"https://www.bit-z.com")
    print("BitZ交易对同步完毕")

...
class dbo:
    ...
    def Bithumb(self, url, exchangePair, exchangeName, exchangeId, exchangeUrl):
        counts = 0
        headers = {
...
if __name__ == "__main__":
    ...
    db.Bithumb("https://api.bithumb.com/public/ticker/ALL", exchangePair,"Bithumb",8,"https://www.bithumb.com/")
    print("Bithumb交易对同步完毕")

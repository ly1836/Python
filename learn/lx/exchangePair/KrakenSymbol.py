        ...
        try:
            ...
            if respone.text.__len__() > 1:
                ...
                for key in d:
                    ...
                    baseCurrency = d[key]['base'].lower()
                    quoteCurrency = d[key]['quote'].lower()
                    counts = counts + 1
                    # flag = 1
...
if __name__ == "__main__":
    ...
    db.zb("https://api.kraken.com/0/public/AssetPairs", exchangePair, "Kraken", 10, "https://www.kraken.com")
    print("Kraken交易对同步完毕")

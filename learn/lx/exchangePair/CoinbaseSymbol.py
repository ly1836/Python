...
class dbo:
    ...
    def coinbase(self, url, exchangePair, exchangeName, exchangeId, exchangeUrl):
        counts = 0
        headers = {
...
if __name__ == "__main__":
    ...
    db.coinbase("https://api-public.sandbox.pro.coinbase.com/products", exchangePair,"Coinbase Pro",228,"https://pro.coinbase.com/")
    print("coinbase交易对同步完毕")

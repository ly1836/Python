        ...
        try:
            ...
            if respone.text.__len__() > 1:
                ...
                for key in d:
                    ...
                    quoteCurrency = (symbol + "")[0:((symbol + "").index("_"))]
                    baseCurrency = (symbol + "")[
...
if __name__ == "__main__":
    ...
    db.zb("https://poloniex.com/public?command=returnTicker", exchangePair, "Poloniex", 18, "https://poloniex.com")
    print("Poloniex交易对同步完毕")

...
class dbo:
    ...
    def UPbit(self, url, exchangePair, exchangeName, exchangeId, exchangeUrl):
        counts = 0
        headers = {
        ...
        try:
            ...
            if respone.text.__len__() > 1:
                ...
                for i in d:
                    ...
                    # 基础币种
                    baseCurrency = str(i['market']).split("-")[1]
                    # 计价币种(此交易所只支持对韩元计价)
                    quoteCurrency = str(i['market']).split("-")[0]
...
if __name__ == "__main__":
    ...
    db.UPbit("https://api.upbit.com/v1/market/all", exchangePair,"UPbit",7,"https://upbit.com/")
    print("UPbit交易对同步完毕")
